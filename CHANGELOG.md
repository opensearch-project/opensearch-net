...
### Dependencies
- Bumps `AWSSDK.Core` from 3.7.204.12 to 3.7.304.16
- Bumps `Bogus` from 35.3.0 to 35.5.1
- Bumps `xunit` from 2.7.1 to 2.8.0
- Bumps `FSharp.Core` from 8.0.100 to 8.0.300
- Bumps `xunit.runner.visualstudio` from 2.5.8 to 2.8.1
...
- Bumps `Octokit` from 11.0.0 to 12.0.0
