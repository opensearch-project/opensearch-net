...
- Generate high-level `ml` namespace client (typed requests, responses, descriptors, and shared models) from the OpenAPI spec via `--include-high-level` ([#1017](https://github.com/opensearch-project/opensearch-net/pull/1017))
