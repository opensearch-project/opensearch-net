...
{
    [U]
    public void DoesNotJoinTwoShouldsUsingAnd() => ReturnsBool(
    ...
    [U]
    public void DoesJoinTwoShouldsUsingOr() => ReturnsBool(
        Query || Query || (Query || Query),
        q => q.Query() || q.Query() || (q.Query() || q.Query()),
        b =>
        {
    ...
    [U]
    public void DoesNotJoinTwoMustsUsingOr() => ReturnsBool(
        Query && Query || Query && Query,
        q => q.Query() && q.Query() || q.Query() && q.Query(),
        b =>
        {
    ...
    [U]
    public void DoesJoinTwoMustsUsingAnd() => ReturnsBool(
        Query && Query && (Query && Query),
        q => q.Query() && q.Query() && (q.Query() && q.Query()),
        b =>
        {
    ...
    [U]
    public void AndJoinsMustNot() => ReturnsBool(
        Query && !Query,
        q => q.Query() && !q.Query(),
        b =>
        {
    ...
    [U]
    public void OrDoesNotJoinMustNot() => ReturnsBool(
        Query || !Query,
        q => q.Query() || !q.Query(),
        b => { b.Should.Should().NotBeEmpty().And.HaveCount(2); });

    [U]
    public void OrDoesNotJoinFilter() => ReturnsBool(
        Query || !Query,
        q => q.Query() || +q.Query(),
        b =>
        {
    ...
    [U]
    public void AndJoinsFilter() => ReturnsBool(
        Query && +Query,
        q => q.Query() && +q.Query(),
        b =>
        {
