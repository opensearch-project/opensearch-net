...
In addition to logging requests and responses, Elasticsearch also 
...
OpenSearch.Net and NEST provide an <<audit-trail, audit trail>> and <<debug-information, debug information>> to 
