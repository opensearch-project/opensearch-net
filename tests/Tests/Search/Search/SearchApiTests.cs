...
namespace Tests.Search.Search
{
        ...
        : ApiIntegrationTestBase<ReadOnlyCluster, ISearchResponse<Project>, ISearchRequest, SearchDescriptor<Project>, SearchRequest<Project>>
    {
        ...
        protected override object ExpectJson => new
        {
            ...
            aggs = new { startDates = new { terms = new { field = "startedOn" } } },
            post_filter = new { term = new { state = new { value = "Stable" } } },
            ext = !TestClient.Configuration.RunIntegrationTests
                ? new { personalize_request_parameters = new { user_id = "<USER_ID>", context = new { DEVICE = "mobile phone" } } }
                : null
        };

        protected override int ExpectStatusCode => 200;

        protected override Func<SearchDescriptor<Project>, ISearchRequest> Fluent => s =>
        {
            s = s
                .From(10)
                .Size(20)
        ...
        protected override SearchRequest<Project> Initializer => new SearchRequest<Project>()
        {
            ...
            Aggregations = new TermsAggregation("startDates") { Field = "startedOn" },
            PostFilter = new QueryContainer(new TermQuery { Field = "state", Value = "Stable" }),
            Ext = !TestClient.Configuration.RunIntegrationTests
                ? new Dictionary<string, object>
                {
    ...
    public class SearchApiDocValueFieldsTests : SearchApiTests
    {
        ...
        protected override object ExpectJson => new
        {
            ...
            aggs = new { startDates = new { terms = new { field = "startedOn" } } },
            post_filter = new { term = new { state = new { value = "Stable" } } },
            docvalue_fields = new object[] { "name", new { field = "lastActivity", format = DateFormat.basic_date }, }
        };
    ...
    public class SearchApiNullQueryContainerTests : SearchApiTests
    {
        ...
        protected override SearchRequest<Project> Initializer => new SearchRequest<Project>()
        {
            Query = new BoolQuery { Must = null, Should = null, MustNot = null }
        };
    ...
    public class SearchApiNullQueriesInQueryContainerTests : SearchApiTests
    {
        ...
        protected override object ExpectJson => new { query = new { @bool = new { } } };
        ...
        : ApiIntegrationTestBase<CrossCluster, ISearchResponse<Project>, ISearchRequest, SearchDescriptor<Project>, SearchRequest<Project>>
    {
        ...
        protected override SearchRequest<Project> Initializer =>
            new SearchRequest<Project>(OpenSearch.Client.Indices.Index<Project>().And("cluster_two:project")) { Query = new MatchAllQuery() };
