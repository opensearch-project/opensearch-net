...
namespace Tests.Search.Request
{
	...
	public class RoyalSeeder
	{
		...
		public RoyalSeeder(IOpenSearchClient client, IndexName index)
		{
			_client = client;
			_index = index;
		}
	...
	*/
		...
		where TRoyal : class, IRoyal
	{
		...
		protected override void IntegrationSetup(IOpenSearchClient client, CallUniqueValues values) => new RoyalSeeder(Client, Index).Seed();
