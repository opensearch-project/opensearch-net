    ...
    where TExistsResponse : ExistsResponse
{
    ...
    protected virtual IOpenSearchClient Client => Cluster.Client;
    ...
    protected virtual void IntegrationSetup(IOpenSearchClient client) { }
    ...
    protected LazyResponses Call<TResponse>(
        Func<List<string>, IOpenSearchClient, Task<TResponse>> requestAsync
    )
        where TResponse : class, IResponse
    {
        var client = Client;
...
#pragma warning restore 7095
    ...
    [I]
    protected virtual async Task GetAfterCreateIsValid() => await AssertOnGetAfterCreate(r =>
    {
        r.ShouldBeValid();
        ExpectAfterCreate(r);
    });
    ...
    [I]
    protected virtual async Task ExistsAfterCreateIsValid() => await AssertOnExistsAfterCreate(r =>
    {
        r.ShouldBeValid();
    ...
    [I]
    protected virtual async Task GetAfterUpdateIsValid() => await AssertOnGetAfterUpdate(r =>
    {
        r.ShouldBeValid();
        ExpectAfterUpdate(r);
    });
    ...
    [I]
    protected virtual async Task ExistsAfterDeleteIsValid() => await AssertOnExistsAfterDelete(r =>
    {
        r.ShouldNotBeValid();
    ...
    [I]
    protected virtual async Task DeleteNotFoundIsNotValid() => await AssertOnDeleteNotFoundAfterDelete(r =>
    {
        r.ShouldNotBeValid();
