...
public class IndexNameInference : DocumentationTestBase
{
    ...
    //hide
    [U]
    public void NoIndexThrowsArgumentException()
    {
        var settings = new ConnectionSettings();
        var resolver = new IndexNameResolver(settings);
    ...
    //hide
    [U]
    public void ArgumentExceptionBubblesOut()
    {
    ...
    //hide
    [U]
    public void RoundTripSerializationPreservesCluster()
    {
    ...
    //hide
    [U]
    public void ImplicitConversionReadsCluster()
    {
