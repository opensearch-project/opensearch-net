...
//					.Replace("}", "}}")
	...
	{
		public SerializationTester(IOpenSearchClient client) => Client = client;
		...
		protected IOpenSearchSerializer Serializer => Client.ConnectionSettings.RequestResponseSerializer;
