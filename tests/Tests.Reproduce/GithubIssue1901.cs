...
<!-- a padding to disable MSIE and Chrome friendly error page -->";
    ...
    [U]
    public async Task BadAuthCarriesStatusCodeAndResponseBodyOverToResponse()
    {
        var client = FixedResponseClient.Create(ProxyAuthResponse, 401,
    ...
    [U]
    public async Task BadMimeMakesA200ResponseUnsuccesful()
    {
    ...
    [U]
    public async Task BadMimeMakesA200ResponseInvalid()
    {
        var client = FixedResponseClient.Create(ProxyAuthResponse, 200,
            s => s.DisableDirectStreaming(),
            "text/html"
