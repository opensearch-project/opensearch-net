...
public class CanonicalRequestTests
{
    ...
    [U]
    public async Task TestDoubleEncodePath()
    {
...
{EmptyBodySha256}");
    ...
    [U]
    public async Task TestBodyIsHashedCorrectly()
    {
...
{bodyHash}");
    ...
    [U]
    public async Task TestDoubleUrlEncode()
    {
        var request = new HttpRequestMessage(HttpMethod.Post,
...
{EmptyBodySha256}");
    ...
    [U]
    public async Task TestTildeInUri()
    {
...
{EmptyBodySha256}");
    ...
    [U]
    public async Task TestQueryParamMultipleValues()
    {
        var request = new HttpRequestMessage(HttpMethod.Get,
...
{EmptyBodySha256}");
    ...
    [U]
    public static async Task TestAllPrintableAsciiQueryParam()
    {
