...
namespace OpenSearch.Client
{
	public partial interface IOpenSearchClient
	{
		...
		/// using <see cref="ConnectionSettingsBase{TConnectionSettings}.DefaultMappingFor{TDocument}"/> on <see cref="Client.ConnectionSettings"/>, an exception will be thrown.
