...
namespace OpenSearch.Client
{
    ...
    public class QueryContainerDescriptor<T> : QueryContainer where T : class
    {
        ...
        public QueryContainer HasRelationName<TRelation>(Expression<Func<T, JoinField>> field) =>
            Term(t => t.Field(field).Value(Infer.Relation<TRelation>()));
        ...
        /// </summary>
        public QueryContainer Wildcard<TValue>(Expression<Func<T, TValue>> field, string value, double? boost = null,
        ...
        /// </summary>
        public QueryContainer Prefix<TValue>(Expression<Func<T, TValue>> field, string value, double? boost = null,
            MultiTermQueryRewrite rewrite = null,
            string name = null
        ) =>
