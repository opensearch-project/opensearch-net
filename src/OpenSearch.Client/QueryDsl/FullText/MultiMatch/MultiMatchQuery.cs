...
namespace OpenSearch.Client
{
	...
	public interface IMultiMatchQuery : IQuery
	{
		...
		/// (below the cutoff) terms in the case of <see cref="Client.Operator.Or" />,
		/// or all of the low frequency terms in the case of an <see cref="Client.Operator.And" /> match.
		/// </summary>
