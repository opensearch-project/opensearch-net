...
using OpenSearch.Client.Specification.SearchRelevanceApi;
...
namespace OpenSearch.Client
{
    ...
    public partial class OpenSearchClient : IOpenSearchClient
    {
        ...
        public ISearchRelevanceNamespace SearchRelevance { get; private set; }
        ...
        partial void SetupGeneratedNamespaces()
        {
            ...
            SearchRelevance = new SearchRelevanceNamespace(this);
        ...
        public Task<ClearScrollResponse> ClearScrollAsync(
            ...
            DoRequestAsync<IClearScrollRequest, ClearScrollResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public CountResponse Count<TDocument>(
            ...
            Count(selector.InvokeOrDefault(new CountDescriptor<TDocument>()));
        ...
        public Task<CountResponse> CountAsync<TDocument>(
            ...
            where TDocument : class =>
            CountAsync(selector.InvokeOrDefault(new CountDescriptor<TDocument>()), ct);
        ...
        public CreateResponse Create<TDocument>(
            ...
            where TDocument : class =>
            Create<TDocument>(
                selector.InvokeOrDefault(new CreateDescriptor<TDocument>(documentWithId: document))
            );
        ...
        public CreateResponse Create<TDocument>(ICreateRequest<TDocument> request)
            where TDocument : class =>
            DoRequest<ICreateRequest<TDocument>, CreateResponse>(
                request,
                request.RequestParameters
            );
        ...
        public Task<CreateResponse> CreateAsync<TDocument>(
            ...
            where TDocument : class =>
            DoRequestAsync<ICreateRequest<TDocument>, CreateResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public DeleteResponse Delete<TDocument>(
            ...
            Delete(
                selector.InvokeOrDefault(
                    new DeleteDescriptor<TDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
                        id: id?.Self?.Id
                    )
                )
        ...
        public DeleteByQueryResponse DeleteByQuery<TDocument>(
            ...
            where TDocument : class =>
            DeleteByQuery(selector.InvokeOrDefault(new DeleteByQueryDescriptor<TDocument>()));
        ...
        public Task<DeleteByQueryResponse> DeleteByQueryAsync<TDocument>(
            ...
            where TDocument : class =>
            DeleteByQueryAsync(
                selector.InvokeOrDefault(new DeleteByQueryDescriptor<TDocument>()),
                ct
            );
        ...
        public ListTasksResponse DeleteByQueryRethrottle(
            ...
            DeleteByQueryRethrottle(
                selector.InvokeOrDefault(new DeleteByQueryRethrottleDescriptor(taskId: taskId))
            );
        ...
        public Task<ListTasksResponse> DeleteByQueryRethrottleAsync(
            ...
            DoRequestAsync<IDeleteByQueryRethrottleRequest, ListTasksResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        ) => DeleteScript(selector.InvokeOrDefault(new DeleteScriptDescriptor(id: id)));
        ...
        public Task<DeleteScriptResponse> DeleteScriptAsync(
            ...
            Func<DeleteScriptDescriptor, IDeleteScriptRequest> selector = null,
            CancellationToken ct = default
        ) => DeleteScriptAsync(selector.InvokeOrDefault(new DeleteScriptDescriptor(id: id)), ct);
        ...
        public Task<DeleteScriptResponse> DeleteScriptAsync(
            ...
            DoRequestAsync<IDeleteScriptRequest, DeleteScriptResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public ExistsResponse DocumentExists<TDocument>(
            ...
            DocumentExists(
                selector.InvokeOrDefault(
                    new DocumentExistsDescriptor<TDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
                        id: id?.Self?.Id
                    )
        ...
        public Task<ExistsResponse> DocumentExistsAsync(
            ...
            DoRequestAsync<IDocumentExistsRequest, ExistsResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public ExistsResponse SourceExists<TDocument>(
            ...
            SourceExists(
                selector.InvokeOrDefault(
                    new SourceExistsDescriptor<TDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
                        id: id?.Self?.Id
                    )
        ...
        public Task<ExistsResponse> SourceExistsAsync(
            ...
            DoRequestAsync<ISourceExistsRequest, ExistsResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public ExplainResponse<TDocument> Explain<TDocument>(
            ...
            Explain<TDocument>(
                selector.InvokeOrDefault(
                    new ExplainDescriptor<TDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
                        id: id?.Self?.Id
                    )
        ...
        public ExplainResponse<TDocument> Explain<TDocument>(IExplainRequest request)
            where TDocument : class =>
            DoRequest<IExplainRequest, ExplainResponse<TDocument>>(
                request,
                request.RequestParameters
            );
        ...
        public Task<ExplainResponse<TDocument>> ExplainAsync<TDocument>(
            ...
            where TDocument : class =>
            DoRequestAsync<IExplainRequest, ExplainResponse<TDocument>>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public FieldCapabilitiesResponse FieldCapabilities(
            ...
            FieldCapabilities(
                selector.InvokeOrDefault(new FieldCapabilitiesDescriptor().Index(index: index))
            );
        ...
        public Task<FieldCapabilitiesResponse> FieldCapabilitiesAsync(
            ...
            DoRequestAsync<IFieldCapabilitiesRequest, FieldCapabilitiesResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public Task<GetResponse<TDocument>> GetAsync<TDocument>(
            ...
            where TDocument : class =>
            DoRequestAsync<IGetRequest, GetResponse<TDocument>>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        ) => GetScript(selector.InvokeOrDefault(new GetScriptDescriptor(id: id)));
        ...
        public Task<GetScriptResponse> GetScriptAsync(
            ...
            Func<GetScriptDescriptor, IGetScriptRequest> selector = null,
            CancellationToken ct = default
        ) => GetScriptAsync(selector.InvokeOrDefault(new GetScriptDescriptor(id: id)), ct);
        ...
        public Task<GetScriptResponse> GetScriptAsync(
            ...
            DoRequestAsync<IGetScriptRequest, GetScriptResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public SourceResponse<TDocument> Source<TDocument>(
            ...
            Source<TDocument>(
                selector.InvokeOrDefault(
                    new SourceDescriptor<TDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
                        id: id?.Self?.Id
                    )
        ...
        public SourceResponse<TDocument> Source<TDocument>(ISourceRequest request)
            where TDocument : class =>
            DoRequest<ISourceRequest, SourceResponse<TDocument>>(
                request,
                ResponseBuilder(
                    request.RequestParameters,
                    SourceRequestResponseBuilder<TDocument>.Instance
                )
            );
        ...
        public Task<SourceResponse<TDocument>> SourceAsync<TDocument>(
            ...
            where TDocument : class =>
            DoRequestAsync<ISourceRequest, SourceResponse<TDocument>>(
                request,
                ResponseBuilder(
                    request.RequestParameters,
                    SourceRequestResponseBuilder<TDocument>.Instance
        ...
        public IndexResponse Index<TDocument>(
            ...
            where TDocument : class =>
            Index<TDocument>(
                selector.InvokeOrDefault(new IndexDescriptor<TDocument>(documentWithId: document))
            );
        ...
        public Task<IndexResponse> IndexAsync<TDocument>(
            ...
            where TDocument : class =>
            DoRequestAsync<IIndexRequest<TDocument>, IndexResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public Task<RootNodeInfoResponse> RootNodeInfoAsync(
            ...
            DoRequestAsync<IRootNodeInfoRequest, RootNodeInfoResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public Task<MultiGetResponse> MultiGetAsync(
            ...
            DoRequestAsync<IMultiGetRequest, MultiGetResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        ) => MultiSearch(selector.InvokeOrDefault(new MultiSearchDescriptor().Index(index: index)));
        ...
        public Task<MultiSearchResponse> MultiSearchAsync(
            ...
            MultiSearchAsync(
                selector.InvokeOrDefault(new MultiSearchDescriptor().Index(index: index)),
                ct
            );
        ...
        public Task<MultiSearchResponse> MultiSearchAsync(
            ...
            DoRequestAsync<IMultiSearchRequest, MultiSearchResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public MultiSearchResponse MultiSearchTemplate(
            ...
            MultiSearchTemplate(
                selector.InvokeOrDefault(new MultiSearchTemplateDescriptor().Index(index: index))
            );
        ...
        public Task<MultiSearchResponse> MultiSearchTemplateAsync(
            ...
            DoRequestAsync<IMultiSearchTemplateRequest, MultiSearchResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public Task<MultiTermVectorsResponse> MultiTermVectorsAsync(
            ...
            DoRequestAsync<IMultiTermVectorsRequest, MultiTermVectorsResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        ) => PutScript(selector.InvokeOrDefault(new PutScriptDescriptor(id: id)));
        ...
        public Task<PutScriptResponse> PutScriptAsync(
            ...
            Func<PutScriptDescriptor, IPutScriptRequest> selector,
            CancellationToken ct = default
        ) => PutScriptAsync(selector.InvokeOrDefault(new PutScriptDescriptor(id: id)), ct);
        ...
        public Task<PutScriptResponse> PutScriptAsync(
            ...
            DoRequestAsync<IPutScriptRequest, PutScriptResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public ReindexRethrottleResponse ReindexRethrottle(
            ...
            ReindexRethrottle(
                selector.InvokeOrDefault(new ReindexRethrottleDescriptor(taskId: taskId))
            );
        ...
        public Task<ReindexRethrottleResponse> ReindexRethrottleAsync(
            ...
            DoRequestAsync<IReindexRethrottleRequest, ReindexRethrottleResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public RenderSearchTemplateResponse RenderSearchTemplate(
            ...
            DoRequest<IRenderSearchTemplateRequest, RenderSearchTemplateResponse>(
                request,
                request.RequestParameters
            );
        ...
        public Task<RenderSearchTemplateResponse> RenderSearchTemplateAsync(
            ...
            DoRequestAsync<IRenderSearchTemplateRequest, RenderSearchTemplateResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public ExecutePainlessScriptResponse<TResult> ExecutePainlessScript<TResult>(
            ...
            ExecutePainlessScript<TResult>(
                selector.InvokeOrDefault(new ExecutePainlessScriptDescriptor())
            );
        ...
        public Task<ExecutePainlessScriptResponse<TResult>> ExecutePainlessScriptAsync<TResult>(
            ...
            ExecutePainlessScriptAsync<TResult>(
                selector.InvokeOrDefault(new ExecutePainlessScriptDescriptor()),
                ct
            );
        ...
        public ExecutePainlessScriptResponse<TResult> ExecutePainlessScript<TResult>(
            ...
            DoRequest<IExecutePainlessScriptRequest, ExecutePainlessScriptResponse<TResult>>(
                request,
                request.RequestParameters
            );
        ...
        public ISearchResponse<TDocument> Scroll<TInferDocument, TDocument>(
            ...
            where TDocument : class =>
            Scroll<TDocument>(
                selector.InvokeOrDefault(new ScrollDescriptor<TInferDocument>(scroll, scrollId))
            );
        ...
        public async Task<ISearchResponse<TDocument>> ScrollAsync<TInferDocument, TDocument>(
            ...
            where TInferDocument : class
            where TDocument : class =>
            await ScrollAsync<TDocument>(
                    selector.InvokeOrDefault(
                        new ScrollDescriptor<TInferDocument>(scroll, scrollId)
                    ),
                    ct
                )
        ...
        public ISearchResponse<TDocument> Scroll<TDocument>(
            ...
            where TDocument : class =>
            Scroll<TDocument>(
                selector.InvokeOrDefault(new ScrollDescriptor<TDocument>(scroll, scrollId))
            );
        ...
        public ISearchResponse<TDocument> Scroll<TDocument>(IScrollRequest request)
            where TDocument : class =>
            DoRequest<IScrollRequest, SearchResponse<TDocument>>(
                request,
                request.RequestParameters
            );
        ...
        public async Task<ISearchResponse<TDocument>> ScrollAsync<TDocument>(
            ...
            where TDocument : class =>
            await DoRequestAsync<IScrollRequest, SearchResponse<TDocument>>(
                    request,
                    request.RequestParameters,
                    ct
                )
        ...
        public ISearchResponse<TDocument> Search<TInferDocument, TDocument>(
            ...
            where TInferDocument : class
            where TDocument : class =>
            Search<TDocument>(selector.InvokeOrDefault(new SearchDescriptor<TInferDocument>()));
        ...
        public async Task<ISearchResponse<TDocument>> SearchAsync<TInferDocument, TDocument>(
            ...
            where TInferDocument : class
            where TDocument : class =>
            await SearchAsync<TDocument>(
                    selector.InvokeOrDefault(new SearchDescriptor<TInferDocument>()),
                    ct
                )
                .ConfigureAwait(false);
        ...
        public ISearchResponse<TDocument> Search<TDocument>(
            ...
            where TDocument : class =>
            Search<TDocument>(selector.InvokeOrDefault(new SearchDescriptor<TDocument>()));
        ...
        public async Task<ISearchResponse<TDocument>> SearchAsync<TDocument>(
            ...
            where TDocument : class =>
            await SearchAsync<TDocument>(
                    selector.InvokeOrDefault(new SearchDescriptor<TDocument>()),
                    ct
                )
                .ConfigureAwait(false);
        ...
        public ISearchResponse<TDocument> Search<TDocument>(ISearchRequest request)
            where TDocument : class =>
            DoRequest<ISearchRequest, SearchResponse<TDocument>>(
                request,
                request.RequestParameters
            );
        ...
        public async Task<ISearchResponse<TDocument>> SearchAsync<TDocument>(
            ...
            where TDocument : class =>
            await DoRequestAsync<ISearchRequest, SearchResponse<TDocument>>(
                    request,
                    request.RequestParameters,
                    ct
                )
        ...
        public SearchShardsResponse SearchShards<TDocument>(
            ...
            where TDocument : class =>
            SearchShards(selector.InvokeOrDefault(new SearchShardsDescriptor<TDocument>()));
        ...
        public Task<SearchShardsResponse> SearchShardsAsync<TDocument>(
            ...
            where TDocument : class =>
            SearchShardsAsync(
                selector.InvokeOrDefault(new SearchShardsDescriptor<TDocument>()),
                ct
            );
        ...
        public Task<SearchShardsResponse> SearchShardsAsync(
            ...
            DoRequestAsync<ISearchShardsRequest, SearchShardsResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public ISearchResponse<TDocument> SearchTemplate<TDocument>(
            ...
            SearchTemplate<TDocument>(
                selector.InvokeOrDefault(new SearchTemplateDescriptor<TDocument>())
            );
        ...
        public async Task<ISearchResponse<TDocument>> SearchTemplateAsync<TDocument>(
            ...
            where TDocument : class =>
            await SearchTemplateAsync<TDocument>(
                    selector.InvokeOrDefault(new SearchTemplateDescriptor<TDocument>()),
                    ct
                )
                .ConfigureAwait(false);
        ...
        public ISearchResponse<TDocument> SearchTemplate<TDocument>(ISearchTemplateRequest request)
            where TDocument : class =>
            DoRequest<ISearchTemplateRequest, SearchResponse<TDocument>>(
                request,
                request.RequestParameters
            );
        ...
        public async Task<ISearchResponse<TDocument>> SearchTemplateAsync<TDocument>(
            ...
            where TDocument : class =>
            await DoRequestAsync<ISearchTemplateRequest, SearchResponse<TDocument>>(
                    request,
                    request.RequestParameters,
                    ct
                )
        ...
        public TermVectorsResponse TermVectors<TDocument>(
            ...
            where TDocument : class =>
            TermVectors<TDocument>(
                selector.InvokeOrDefault(new TermVectorsDescriptor<TDocument>())
            );
        ...
        public TermVectorsResponse TermVectors<TDocument>(ITermVectorsRequest<TDocument> request)
            where TDocument : class =>
            DoRequest<ITermVectorsRequest<TDocument>, TermVectorsResponse>(
                request,
                request.RequestParameters
            );
        ...
        public Task<TermVectorsResponse> TermVectorsAsync<TDocument>(
            ...
            where TDocument : class =>
            DoRequestAsync<ITermVectorsRequest<TDocument>, TermVectorsResponse>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public UpdateResponse<TDocument> Update<TDocument, TPartialDocument>(
            ...
            Update<TDocument, TPartialDocument>(
                selector.InvokeOrDefault(
                    new UpdateDescriptor<TDocument, TPartialDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
                        id: id?.Self?.Id
                    )
        ...
        public Task<UpdateResponse<TDocument>> UpdateAsync<TDocument, TPartialDocument>(
            ...
            where TDocument : class
            where TPartialDocument : class =>
            UpdateAsync<TDocument, TPartialDocument>(
                selector.InvokeOrDefault(
                    new UpdateDescriptor<TDocument, TPartialDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
        ...
        public UpdateResponse<TDocument> Update<TDocument>(
            DocumentPath<TDocument> id,
            Func<
                UpdateDescriptor<TDocument, TDocument>,
                IUpdateRequest<TDocument, TDocument>
            > selector
        )
            where TDocument : class =>
            Update<TDocument, TDocument>(
                selector.InvokeOrDefault(
                    new UpdateDescriptor<TDocument, TDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
                        id: id?.Self?.Id
                    )
        ...
        public Task<UpdateResponse<TDocument>> UpdateAsync<TDocument>(
            ...
            where TDocument : class =>
            UpdateAsync<TDocument, TDocument>(
                selector.InvokeOrDefault(
                    new UpdateDescriptor<TDocument, TDocument>(
                        documentWithId: id?.Document,
                        index: id?.Self?.Index,
        ...
        public UpdateResponse<TDocument> Update<TDocument, TPartialDocument>(
            ...
            where TDocument : class
            where TPartialDocument : class =>
            DoRequest<IUpdateRequest<TDocument, TPartialDocument>, UpdateResponse<TDocument>>(
                request,
                request.RequestParameters
            );
        ...
        public Task<UpdateResponse<TDocument>> UpdateAsync<TDocument, TPartialDocument>(
            ...
            where TDocument : class
            where TPartialDocument : class =>
            DoRequestAsync<IUpdateRequest<TDocument, TPartialDocument>, UpdateResponse<TDocument>>(
                request,
                request.RequestParameters,
                ct
            );
        ...
        public UpdateByQueryResponse UpdateByQuery<TDocument>(
            ...
            where TDocument : class =>
            UpdateByQuery(selector.InvokeOrDefault(new UpdateByQueryDescriptor<TDocument>()));
        ...
        public Task<UpdateByQueryResponse> UpdateByQueryAsync<TDocument>(
            ...
            where TDocument : class =>
            UpdateByQueryAsync(
                selector.InvokeOrDefault(new UpdateByQueryDescriptor<TDocument>()),
                ct
            );
        ...
        public ListTasksResponse UpdateByQueryRethrottle(
            ...
            UpdateByQueryRethrottle(
                selector.InvokeOrDefault(new UpdateByQueryRethrottleDescriptor(taskId: taskId))
            );
        ...
        public Task<ListTasksResponse> UpdateByQueryRethrottleAsync(
            ...
            DoRequestAsync<IUpdateByQueryRethrottleRequest, ListTasksResponse>(
                request,
                request.RequestParameters,
                ct
            );
