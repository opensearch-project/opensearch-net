...
public class DynamicValue : DynamicObject, IEquatable<DynamicValue>, IConvertible
{
    ...
    public static implicit operator string(DynamicValue dynamicValue) => dynamicValue.HasValue
    ...
    {
        if (dynamicValue._value is Guid guid)
        {
            return guid;
        }
    ...
    {
        if (dynamicValue._value is DateTime time)
        {
            return time;
        }
    ...
    {
        if (dynamicValue._value is TimeSpan span)
        {
            return span;
        }
