    ...
    where T : ConnectionConfiguration<T>
{
    ...
    protected ConnectionConfiguration(IConnectionPool connectionPool, IConnection connection, IOpenSearchSerializer requestResponseSerializer)
    {
        ...
        _urlFormatter = new OpenSearchUrlFormatter(this);
    ...
    IOpenSearchSerializer IConnectionConfigurationValues.RequestResponseSerializer => UseThisRequestResponseSerializer;
    ...
    OpenSearchUrlFormatter IConnectionConfigurationValues.UrlFormatter => _urlFormatter;
    ...
    /// <summary>
    /// Ensures the response bytes are always available on the <see cref="OpenSearchResponse{T}" />
    /// <para>
