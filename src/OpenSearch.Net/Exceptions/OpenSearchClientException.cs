...
using static OpenSearch.Net.ResponseStatics;

namespace OpenSearch.Net;

public class OpenSearchClientException : Exception
{
    public OpenSearchClientException(string message) : base(message) => FailureReason = PipelineFailure.Unexpected;
