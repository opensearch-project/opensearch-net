...
public sealed class SearchPipelineModelOverrides : ModelOverridesBase
{
    ...
    /// <summary>
    /// Search pipeline operations use the high-level client namespace generated by the
    /// standard Requests/Descriptors Razor templates (driven by [MapsApi] on hand-written
    /// request files). We only want this overrides class to generate the shared model types
